...
//   temp+=`<tr><td>${book.id}</td><td>${book.title}</td><td><td>${book.price}</td><td>${book.author}</td><td><a><i class="fa fa-edit"></i></a><a onclick=DeleteBook(${index})><i class="fa fa-trash"></i></a></td></tr>`
// })
// var tbl =_("tbl");
...
//    }
//  }
//  _("btn_add").addEventListener("click",OurBook);
...
var Books=function(id,title,price,author){
  ...
  function BindBook(books){
    ...
    var temp=``
    books.forEach(function(book,index){
        temp+=`<tr><td>${book.id}</td><td>${book.title}</td><td>${book.price}</td><td>${book.author}</td><td><a><a onclick="editBook(${index})"><i class="fa fa-edit"></i></a><a onclick=DeleteBook(${index})><i class="fa fa-trash"></i></a></td></tr>`
    })
    var tbl=_("tbl");
